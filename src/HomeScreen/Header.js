...
import { Avatar, IconButton, Title, Button, Menu, Divider, Provider, Paragraph, ActivityIndicator, Subheading, Headline, Caption } from 'react-native-paper'
import { useDispatch, useSelector } from 'react-redux'
import { blockAndRemove, openBlockModal, setFeedState } from '../redux/actions'
import Icon from 'react-native-vector-icons/MaterialCommunityIcons';
import * as RootNavigation from '../../RootNavigation';
import Feather from 'react-native-vector-icons/Feather';
const Header = ({user,showBlock,showReport,post}) => {
